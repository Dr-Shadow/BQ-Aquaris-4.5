...
#MTK_BUILD_VERNO = 2.0.8 20130904-10:17
	# Depend on release week

MTK_WEEK_NO =  
	# Depend on release week

AEON_SW_VERSION = Aquaris4.5-QB1D-K504-JB-6577V1.0.0 
AEON_SW_VERSION_INCREMENTAL = B07T01   

 AEON_CUSTOM_BTNAME = bq Aquaris
...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME = MTK_TETHERING_EEM_SUPPORT MTK_CAMERA_YUV_AUTOFLASHLIGHT MTK_SDIO_DATA_DELAY_SETTINGS_SUPPORT MTK_ACMT_DEBUG MTK_BT_PROFILE_AVRCP MTK_MMPROFILE_SUPPORT MTK_GPS_SUPPORT EVDO_DT_SUPPORT MTK_CAMCORDER_PROFILE_MID_MP4 MTK_FM_SUPPORT MTK_USES_HD_VIDEO MTK_TABLET_PLATFORM MTK_AUTO_DETECT_MAGNETOMETER MTK_MULTI_PATCH_SUPPORT CUSTOM_KERNEL_OFN MTK_BT_PROFILE_MANAGER MTK_TVOUT_SUPPORT MTK_FM_RECORDING_SUPPORT MTK_DEDICATEDAPN_SUPPORT MTK_BT_PROFILE_HIDH MTK_IPV6_SUPPORT MTK_DT_SUPPORT MTK_STEREO3D_WALLPAPER_APP MTK_BT_FM_OVER_BT_VIA_CONTROLLER MTK_BT_PROFILE_PBAP MTK_NFC_SUPPORT MTK_MASS_STORAGE MTK_ENABLE_VIDEO_EDITOR MTK_BT_PROFILE_HFP MTK_BT_PROFILE_AVRCP14 MTK_BT_PROFILE_DUN MTK_BICR_SUPPORT MTK_BT_PROFILE_BIP MTK_BT_PROFILE_BPP MTK_COMBO_QUICK_SLEEP_SUPPORT MTK_THEMEMANAGER_APP MTK_HDR_SUPPORT HAVE_AACENCODE_FEATURE MTK_BT_PROFILE_MAPS MTK_FM_50KHZ_SUPPORT MTK_WIFI_HOTSPOT_SUPPORT MTK_TB_DEBUG_SUPPORT MTK_COMBO_SUPPORT MTK_BT_PROFILE_OPP CUSTOM_KERNEL_GYROSCOPE MTK_BT_PROFILE_MAPC MTK_SHARED_SDCARD MTK_DSPIRDBG MTK_EAP_SIM_AKA MTK_MULTI_STORAGE_SUPPORT MTK_ZSD_AF_ENHANCE CUSTOM_KERNEL_ALSPS MTK_SD_REINIT_SUPPORT CUSTOM_KERNEL_ACCELEROMETER MTK_DUAL_MIC_SUPPORT MTK_WAPI_SUPPORT MTK_FD_SUPPORT MTK_DISPLAY_HIGH_RESOLUTION MTK_FAN5405_SUPPORT MTK_TABLET_DRAM MODEM_UMTS_TDD128_MODE MTK_FACEBEAUTY_SUPPORT EVDO_DT_VIA_SUPPORT MTK_BT_SUPPORT MTK_BT_40_SUPPORT MTK_BT_PROFILE_FTP MTK_ASF_PLAYBACK_SUPPORT PLATFORM_VERSION_V4_1_2 MTK_HIGH_QUALITY_THUMBNAIL MTK_FM_RX_SUPPORT MTK_IMAGE_LARGE_MEM_LIMIT MTK_FM_TX_SUPPORT MTK_BRAZIL_CUSTOMIZATION_VIVO MTK_BRAZIL_CUSTOMIZATION_CLARO HAVE_XLOG_FEATURE MTK_RMVB_PLAYBACK_SUPPORT MTK_BT_PROFILE_TIMES MTK_AUTORAMA_SUPPORT MTK_BT_PROFILE_TIMEC MTK_MATV_ANALOG_SUPPORT MTK_BSP_PACKAGE MTK_SIM_AUTHENTICATION_SUPPORT MTK_BRAZIL_CUSTOMIZATION MTK_BT_PROFILE_A2DP MTK_VT3G324M_SUPPORT MTK_CTA_SUPPORT MTK_NVRAM_SECURITY CUSTOM_KERNEL_MAGNETOMETER MTK_BT_PROFILE_PAN MTK_PRODUCT_INFO_SUPPORT MTK_CAMERA_APP_3DHW_SUPPORT MTK_WLAN_SUPPORT MTK_TETHERINGIPV6_SUPPORT MTK_AUTO_DETECT_ACCELEROMETER MTK_EMMC_SUPPORT_OTP MTK_TB_APP_CALL_FORCE_SPEAKER_ON MTK_TB_HW_DEBUG MTK_2SDCARD_SWAP MTK_QVGA_LANDSCAPE_SUPPORT MTK_FM_SHORT_ANTENNA_SUPPORT MTK_HDMI_SUPPORT MTK_RILD_READ_IMSI MTK_BT_PROFILE_SPP MTK_BT_30_SUPPORT MTK_NCP1851_SUPPORT MTK_LCA_SUPPORT MTK_BT_PROFILE_SIMAP MTK_BT_PROFILE_PRXM MTK_FSCK_MSDOS_MTK MTK_MAV_SUPPORT HAVE_AWBENCODE_FEATURE MTK_CAMERA_BSP_SUPPORT MTK_SPH_EHN_CTRL_SUPPORT MTK_WB_SPEECH_SUPPORT MTK_BT_PROFILE_PRXR ENCRY_PARTITION_SUPPORT CUSTOM_HAL_FMRADIO MTK_COMBO_CORE_DUMP_SUPPORT MTK_SENSOR_SUPPORT MTK_M4U_SUPPORT MTK_EMMC_SUPPORT MTK_BT_21_SUPPORT MTK_S3D_SUPPORT MTK_WLANBT_SINGLEANT
...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE=MTK_LCM_PHYSICAL_ROTATION LCM_WIDTH EMMC_CHIP MTK_SINGLE_3DSHOT_SUPPORT MTK_SHARE_MODEM_SUPPORT MTK_NEON_SUPPORT MTK_SHARE_MODEM_CURRENT LCM_HEIGHT
...
MTK_CAMERA_YUV_AUTOFLASHLIGHT =no
...
MTK_SDIO_DATA_DELAY_SETTINGS_SUPPORT=no
...
PLATFORM_VERSION_V4_1_2=no
MTK_ZSD_AF_ENHANCE = no
